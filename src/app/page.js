  ...
  return (
    <div className="min-h-screen w-full">
      ...
      {ipData && ipData.location && (
        <div className="">
          <div className='relative z-40 flex items-center justify-center bg-blue-200'>
            ...
            <p className='text-xl font-bold'>{ipData.ip}</p>
            </div>
            {/* for the location */}
            <div className=' md:border-r-2 md:border-slate-200 md:pr-8 px-5 mx-3 text-center md:text-start'>
            <p className='text-[8px] text-dark-gray font-bold tracking-widest '>LOCATION:</p>
            <p className='text-xl font-bold'>{ipData.location.region}, {ipData.location.country}</p>
            </div>
          {/* fpr the timezone */}
          <div className=' md:border-r-2 md:border-slate-200 md:pr-8 px-5 mx-3 text-center md:text-start'>
          <p className='text-[8px] text-dark-gray font-bold tracking-widest '><>Timezone:</></p>
          <p className='text-xl font-bold'>{ipData.location.timezone}</p>
          </div>
          {/* for the isp */}
          ...
          <p className='text-xl font-bold'>{ipData.isp}</p>
          </div>
            </div>
